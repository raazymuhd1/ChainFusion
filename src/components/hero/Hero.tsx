  ...
  return (
    <section className={`min-h-[500px] mt-[90px]  flex flex-col gap-[50px]`}>
        ...
        <div className={`w-[60%] mx-auto grid grid-cols-1 justify-items-center gap-[10px]`}>
            ...
            <h2 className='text-[clamp(1.5em,4em,4em)] text-[#6d4186] mt-[-40px] font-extrabold'> Any Blockchain </h2>
        ...
        <div className='flex items-center gap-[20px] w-[30%] mx-auto justify-center '>
            <CustomButton styles='bg_gradients' title="Start Exploring" Icon={FaArrowRightLong} />
            <CustomButton styles='glass_bg' title="Watch Demo" />
        </div>
    </section>
  )
}

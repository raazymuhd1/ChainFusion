...
const Footer = () => {
  return (
    <footer className='border-t-[1px_var(--border-col)]  mt-[80px] flex flex-col gap-[10px] p-[20px] items-center w-full shadow-[0_2px_400px_0_rgba(245,97,0,255)] footer_shadows'>
        {/* logo */}

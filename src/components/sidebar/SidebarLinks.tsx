    ...
    <section className='w-full flex flex-col gap-[10px] items-center mt-[30px]'>
        ...
        { activeSidebar.map(link => (
             <Link 
                ...
                key={link.id}
                href={link.url} className={`flex items-center gap-[10px] rounded-[15px] hover:bg-[#18191d] transition-[background_1s] cursor-pointer p-[10px] w-[80%] ${link.isActive == true && "bg-[var(--main-color)]"} `}>
